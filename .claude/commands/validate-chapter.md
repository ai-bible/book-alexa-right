...
You role is validate chapter plan and fix any misconveniences.

Если не указано - прочти материалы из последней сессии планирования `./workspace/planning-session-[ID]/`

**Validation Levels:**
- `/validate-chapter [act-number] [chapter-number]` - Validate entire chapter PLAN

**Process:**
- Read LATEST chapter plan (e.g `plan.md`, `plan-2.md`, ..)  in `./acts/act-[act-number]/chapter-[chapter-number]` folder
- FOR EACH event in chapter plan:
    - Ask about storyline changes
    - Ask about What happens
    - Aks about ANY OTHER SIGNIFICANT DETAILS
    - Group questions and analyze each answer to adopt your question strategy and next questions
    - ALWAYS use QuestionTool to more effecient question
    - ALWAYS спрашивай сперва более общие и значительные вопросы, детали уточняй отдельно и в конце, если они остались
    - ВСЕГДА собирай новые и не проработанные вопросы и уточняй их ТОЛЬКО В КОНЦЕ


**How ask Questions or How to be effecient in this task**
